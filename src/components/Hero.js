...
export default function Hero() {
    ...
    window.onload = function () {
        ...
        style.type = "text/css";
        style.innerHTML = ".typewrite > .wrap { border-right: 0.08em solid #1A3066 }";
            ...
            <Grid container spacing={3} className='heroSection'>
                <Grid item xs={12}>
                    <h2 className='bigHeading'>
                        You're Just a step away from having your very own <span style={{ color: '#FF6326', fontFamily: 'Space Grotesk' }}><br />
